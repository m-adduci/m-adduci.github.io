...
function sortCountries(a, b) {
  var _a = a.feature.properties.Country;
  var _b = b.feature.properties.Country;
  if (_a < _b) {
    return -1;
  }
  if (_a > _b) {
...
L.Control.Search = L.Control.extend({
    ...
    if (e.keyCode === 38 || e.keyCode === 40) {
      ...
      if (this.input.value.length > 2) {
        ...
        var results = _.take(_.filter(this.options.data, function(x) {
          return x.feature.properties.Country.toUpperCase().indexOf(value.toUpperCase()) > -1;
        }).sort(sortCountries), 10);
        _.map(results, function(x) {
          var a = L.DomUtil.create('a', 'list-group-item');
          a.href = '';
          a.setAttribute('data-result-name', x.feature.properties.Country);
          a.innerHTML = x.feature.properties.Country;
  ...
  itemSelected: function(e) {
    ...
    var feature = _.find(this.options.data, function(x) {
      return x.feature.properties.Country === this.input.value;
    }, this);
    if (feature) {
